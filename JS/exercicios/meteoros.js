...
let data_atual = new Date(); // retorna a data da máquina
let mes_atual = data_atual.getMonth();  //retorna o mes atual de 0 a 11

if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do primeiro semestre são: \n"+meteoros_trimestre_um);
else if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do segundo semestre são: \n"+meteoros_trimestre_dois);
else  if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do terceiro semestre são: \n"+meteoros_trimestre_tres);
else  if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do quarto semestre são: \n"+meteoros_trimestre_quatro);
else  
