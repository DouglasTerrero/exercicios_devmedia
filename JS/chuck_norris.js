...
if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do primeiro semestre são: "+meteoros_trimestre_um);
else if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do segundo semestre são: "+meteoros_trimestre_dois);
else  if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do terceiro semestre são: "+meteoros_trimestre_tres);
else  if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2)
  console.log("As chuvas de meteoro do quarto semestre são: "+meteoros_trimestre_quatro);
else  
